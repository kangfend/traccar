...
public class CastelProtocolDecoder extends BaseProtocolDecoder {
    ...
    private void decodeStat(Position position, ByteBuf buf) {
        ...
        position.set(Position.KEY_CURRENT_FUEL_CONSUMPTION, buf.readUnsignedShortLE() * 0.01); // current fuel consumption
    ...
    private Object decodeSc(
        ...
        switch (type) {
            ...
            case MSG_SC_FUEL:
                ...
                long currentFuelConsumption = buf.readUnsignedShortLE(); // current fuel consumption
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    position.set(Position.KEY_CURRENT_FUEL_CONSUMPTION, currentFuelConsumption * 0.01);
